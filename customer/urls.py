...
urlpatterns = [
    ...
    path('case/<str:case_id>/', views.customer_case_view, name="CUSTCaseDetail"),
    path('case/<str:case_id>/<int:file_id>/', views.customer_case_file_upload, name="CUSTFileUpload"),
